...
(function () {
  ...
  const CONTEXTO_BAIRROS = {
    ...
    'Grajaú':            { ref: 'Terminal Grajaú, Represa Billings', janela: 'diurna e noturna', tipo_obra: 'reformas e autoconstrução residencial', acesso: 'Região distante (~26km do centro) — rota mais longa', regra: 'Subprefeitura Capela do Socorro — máximo 3 dias em via pública' },
    'Pirituba':          { ref: 'Parque Estadual do Jaraguá', janela: 'diurna', tipo_obra: 'reformas residenciais', acesso: 'Relevo acentuado perto do Pico do Jaraguá', regra: 'Subprefeitura Pirituba-Jaraguá — máximo 3 dias em via pública' },
    'Cidade Dutra':      { ref: 'Autódromo de Interlagos, Represa Guarapiranga', janela: 'diurna e noturna', tipo_obra: 'reformas e obras residenciais', acesso: 'Região distante (Zona Sul extrema) — rota mais longa', regra: 'Subprefeitura Capela do Socorro — máximo 3 dias em via pública' },
    'Casa Verde':        { ref: 'Av. Braz Leme, Shopping Center Norte', janela: 'diurna', tipo_obra: 'reformas residenciais', acesso: 'Acesso fácil — avenidas largas', regra: 'Subprefeitura Casa Verde/Cachoeirinha — máximo 3 dias em via pública' },
    'Ermelino Matarazzo':{ ref: 'divisa com Guarulhos', janela: 'diurna e noturna', tipo_obra: 'reformas residenciais e industriais', acesso: 'Região distante (Zona Leste) — rota mais longa', regra: 'Subprefeitura Ermelino Matarazzo — máximo 3 dias em via pública' },
    'Guaianases':        { ref: 'Estação Guaianases (Linha 11-Coral)', janela: 'diurna e noturna', tipo_obra: 'reformas residenciais', acesso: 'Extremo leste — rota mais longa', regra: 'Subprefeitura Guaianases — máximo 3 dias em via pública' },
    'Sapopemba':         { ref: 'Parque do Carmo', janela: 'diurna e noturna', tipo_obra: 'reformas residenciais', acesso: 'Região distante (Zona Leste) — rota mais longa', regra: 'Subprefeitura Sapopemba — máximo 3 dias em via pública' },
    'Itaim Paulista':    { ref: 'não confundir com Itaim Bibi', janela: 'diurna e noturna', tipo_obra: 'reformas residenciais', acesso: 'Extremo leste — rota mais longa', regra: 'Subprefeitura Itaim Paulista — máximo 3 dias em via pública' },
    'Perus':             { ref: 'Parque Anhanguera', janela: 'diurna e noturna', tipo_obra: 'reformas residenciais', acesso: 'Extremo noroeste — rota mais longa', regra: 'Subprefeitura Perus/Anhanguera — máximo 3 dias em via pública' },
    'Jaraguá':           { ref: 'Pico do Jaraguá', janela: 'diurna', tipo_obra: 'reformas residenciais', acesso: 'Relevo acentuado perto do parque estadual', regra: 'Subprefeitura Pirituba-Jaraguá — máximo 3 dias em via pública' },
    ...
    'Vila Matilde':      { ref: 'Metrô Vila Matilde, Radial Leste', janela: 'comercial 7h–17h', tipo_obra: 'reforma de casas e sobrados antigos, pequenas obras comerciais', acesso: 'Trânsito intenso perto da Radial Leste — priorizar ruas internas', regra: 'Subprefeitura Penha — máximo 3 dias em via pública' },

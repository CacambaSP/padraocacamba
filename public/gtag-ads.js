// gtag-ads.js — Google Ads (AW-3725861429) + eventos de conversão
...
// Formato do rótulo: o que vem depois da barra em AW-3725861429/XXXXXXXX

(function () {
  var ADS_ID = 'AW-3725861429';

  var LABELS = {
    whatsapp_responsavel: '', // clique no botão "Falar com o responsável" (escala do PC)
    cadastro: ''              // clique no botão "Preencher cadastro e fechar pedido"
  };
